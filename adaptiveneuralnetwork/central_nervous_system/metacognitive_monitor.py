...
class MetacognitiveMonitor(Callback):
    ...
    def on_batch_end(self, batch: int, trainer: Any, logs: Optional[Dict[str, Any]] = None):
        ...
        if self.last_loss is not None:
            ...
            if self.narrative is not None:
                ...
                intent = self.tom.estimate_intent(entity_id, current_input, gist, env_context=somatic_context)
