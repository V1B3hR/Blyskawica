...
from adaptiveneuralnetwork.central_nervous_system.metrics import PhiCalculator
...
class TopologyAdapter(nn.Module):
    ...
    def adapt(self, dynamics_module: nn.Module):
        ...
        current_complexity = self.sp.calculate_complexity_pressure(dynamics_module.state_update.weight)  # noqa: F841
