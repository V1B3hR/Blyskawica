...
class TunedAdaptiveFieldNetwork:
    ...
    def __init__(self, nodes, capacitors, api_endpoints=None, enable_time_series=True, enable_security=True):
        ...
        from adaptiveneuralnetwork.api_integration.ai_api import AISignalManager
        from adaptiveneuralnetwork.api_integration.human_api import HumanSignalManager
        from adaptiveneuralnetwork.api_integration.signal_adapter import SignalAdapter
