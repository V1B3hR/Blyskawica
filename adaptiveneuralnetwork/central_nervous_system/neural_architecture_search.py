            ...
            for arch in current_population:
                if arch.architecture_id not in self.evaluation_results:
                    try:
                        ...
                        # Update architecture with all evaluation metrics first, then overwrite with objective scores
                        arch.performance_metrics.update(evaluation_data)
                        ...
                        if corrections:
                            ...
                            corrected_arch.performance_metrics.update(corrected_evaluation)
