...
@dataclass
class MemoryConfig:
    """Configuration for memory and retrieval parameters."""
    chunk_size: int = 800  # Default memory chunk size in tokens (was 1000)
    overlap: int = 100     # Memory chunk overlap
...
class EnvironmentAdaptationConfig:
    ...
    adaptation_rate: float = 0.08  # Decelerated for stability (was 0.1)
