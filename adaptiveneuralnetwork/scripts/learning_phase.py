...
from adaptiveneuralnetwork.cognitive_tools.diamond_yantra import neuro_gate, DiamondYantraEngine
...
def run_learning_session():
    ...
    for i in range(0, len(words), 10):
        ...
        if neuro_gate(current_oxt, current_ach, ach_threshold=0.8):
            print(f"    [NeuroGate] Aktywacja Diamentu. Zbyt wysoka abstrakcja. Kompresowanie wiedzy w geometrię 3D.")
