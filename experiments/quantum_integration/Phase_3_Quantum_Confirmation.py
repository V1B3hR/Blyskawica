...
def main():
    ...
    print(f"  [Plan] Wykorzystanie budżetu: ~60-120 sekund QPU (Faza Bierzmowania)")
    ...
    results = job.result()
    print(f"  [IBM] Wyniki otrzymane! Analiza zmian strukturalnych...")
    ...
    print(f"  Plik wynikowy: quantum_confirmation_results.json")
    print("="*60 + "\n")
