...
class Phase10FinalValidation:
    ...
    def subphase_10_1_held_out_validation(self) -> dict[str, Any]:
        ...
        for model_name, model_info in self.trained_models.items():
            ...
            model = model_info['model']  # noqa: F841
            y_pred_test = model_info['predictions_test']
            y_pred_train = model_info['predictions_train']  # noqa: F841
            ...
            # Per-class metrics
            class_report = classification_report(self.y_test, y_pred_test, output_dict=True, zero_division=0)  # noqa: F841
            ...
            # Confusion matrix
            cm = confusion_matrix(self.y_test, y_pred_test)  # noqa: F841
            ...
            if generalization_analysis['overfitting_detected']:
                self.log("    ⚠️  Warning: Overfitting detected (gap > 0.10)", "WARN")
    ...
    def subphase_10_2_end_to_end_pipeline(self) -> dict[str, Any]:
        ...
        try:
            ...
            y_test = test_data[target_col]  # noqa: F841
        ...
        try:
            ...
            for model_name, model_info in self.trained_models.items():  # noqa: B007
                model = model_info['model']
    ...
    def run_phase_10(self) -> dict[str, Any]:
        ...
        loaded_phase9 = self.load_phase9_results()  # noqa: F841
...
def main():
    ...
    try:
        results = validator.run_phase_10()  # noqa: F841
