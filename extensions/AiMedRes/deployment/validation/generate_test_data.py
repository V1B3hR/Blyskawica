...
def main():
    ...
    for condition in conditions:
        ...
        # Generate samples
        samples = []
        for i in range(args.samples):  # noqa: B007
    ...
    if args.longitudinal > 0:
        ...
        for condition in ['parkinsons', 'alzheimer']:  # Focus on conditions with progression
            longitudinal_data = []
            for i in range(args.longitudinal):  # noqa: B007
...
"""
    ...
    if args.longitudinal > 0:
        readme_content += "\n### Longitudinal Data\n"
        readme_content += "- `parkinsons_longitudinal_data.json`: Longitudinal Parkinson's cases\n"
        readme_content += "- `alzheimer_longitudinal_data.json`: Longitudinal Alzheimer's cases\n"
