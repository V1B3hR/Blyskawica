...
from aimedres.security.performance_monitor import ClinicalPriority
...
def demonstrate_performance_optimization():
    ...
    for priority, task in priorities:
        ...
        result = engine.safe_think('DemoAgent', task, clinical_priority=priority)  # noqa: F841
...
def demonstrate_bias_detection():
    ...
    for decision_data in test_decisions:
        decision = safety_monitor.assess_ai_decision(**decision_data)  # noqa: F841
