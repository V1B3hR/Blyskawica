...
def run_demo_training(max_samples=100, epochs=2, batch_size=8):
    ...
    try:
        ...
        logger.info(f"   Label distribution: {dict([(label, labels.count(label)) for label in set(labels)])}")  # noqa: C404
        ...
        for epoch in range(epochs):
            ...
            for batch_idx, (images, labels_batch) in enumerate(train_loader):  # noqa: B007
