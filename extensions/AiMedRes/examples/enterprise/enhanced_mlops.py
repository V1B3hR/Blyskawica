...
def demonstrate_model_promotion():
    ...
    try:
        ...
        promotion_gate = ModelPromotionGate(  # noqa: F841
...
def demonstrate_semantic_reasoning():
    ...
    elevated risk for progression. Early detection and intervention are critical."""  # noqa: W291, W293

    print(f"    Response: {response[:100]}...")
    print("    Confidence: 0.87 (based on 3 high-relevance memories)")
