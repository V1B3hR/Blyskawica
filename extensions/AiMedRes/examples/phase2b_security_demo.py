...
def demo_quantum_crypto():
    ...
    print("✓ Data encrypted using hybrid mode")
...
def demo_blockchain():
    ...
    print("✓ Audit entry 1: Dr. Smith viewed patient record")
    ...
    print("✓ Audit entry 2: Dr. Smith updated medication")
    ...
    print("✓ Audit entry 3: Nurse Jones viewed vitals")
    ...
    print("✓ Consent granted for patient_12345")
    print("  - Consent type: data_sharing")
...
def demo_integrated_workflow():
    ...
    print("✓ Session created for Dr. Johnson")
    ...
    decrypted_data = qsc.hybrid_decrypt(encrypted_data, private_key)  # noqa: F841
    print("✓ Data encrypted and decrypted using quantum-safe hybrid encryption")
    ...
    print("✓ Access recorded on immutable blockchain audit trail")
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    try:
        ...
        zt = demo_zero_trust()  # noqa: F841
        qsc = demo_quantum_crypto()  # noqa: F841
        bc = demo_blockchain()  # noqa: F841
