...
from ..multimodal_schema import DatasetInterface, ModalityData, MultiModalSample
...
class DEAPLoader(DatasetInterface):
    ...
    def __init__(self,
                 ...
                 source_localization: Any | None = None,
    ...
    def _get_array(self, data_dict, possible_keys: list[str]) -> np.ndarray | None:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        stats = {
            ...
            'n_subjects': len(set(s.user_id for s in self.samples)),  # noqa: C401
        }
        ...
        if categories:
            stats['categorical_distribution'] = {
                int(k): int(v) for k, v in zip(*np.unique(categories, return_counts=True))  # noqa: B905
            }
