...
from .encoders_eeg import create_eeg_encoder
from .encoders_multimodal import (
    create_physio_encoder,
    create_text_encoder,
    create_voice_encoder,
)
from .fusion import create_fusion_layer
from .heads import create_output_heads
...
class AffectiveModel(keras.Model):
    ...
    def __init__(self,
                 config: dict,
                 enable_modalities: dict[str, bool] | None = None,
                 **kwargs):
        """
        Args:
