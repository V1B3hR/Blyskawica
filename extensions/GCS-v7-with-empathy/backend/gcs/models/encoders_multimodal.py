...
class PhysioEncoder(keras.Model):
    ...
    def __init__(self,
                 input_dim: int = 24,
                 hidden_dims: list[int] = [64, 128],  # noqa: B006
    ...
    def call(self, inputs, training=None):
        ...
        for dense, bn, dropout in zip(self.dense_layers, self.bn_layers, self.dropout_layers):  # noqa: B905
            x = dense(x)
...
class VoiceEncoder(keras.Model):
    ...
    def __init__(self,
                 input_dim: int = 128,
                 hidden_dims: list[int] = [256, 256],  # noqa: B006
