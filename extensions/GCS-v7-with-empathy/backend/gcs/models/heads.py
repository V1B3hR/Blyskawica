...
class ValenceHead(keras.Model):
    ...
    def __init__(self,
                 input_dim: int = 512,
                 hidden_dims: list[int] = [256, 128],  # noqa: B006
                 **kwargs):
...
class CategoricalHead(keras.Model):
    ...
    def __init__(self,
                 input_dim: int = 512,
                 hidden_dims: list[int] = [512, 256],  # noqa: B006
                 num_classes: int = 28,
...
class MultiTaskHeads(keras.Model):
    ...
    def __init__(self,
                 input_dim: int = 512,
                 valence_hidden: list[int] = [256, 128],  # noqa: B006
                 arousal_hidden: list[int] = [256, 128],  # noqa: B006
                 categorical_hidden: list[int] = [512, 256],  # noqa: B006
                 num_classes: int = 28,
                 use_temperature_scaling: bool = True,
                 **kwargs):
        super().__init__(**kwargs)
