...
class Participant:
    ...
    well_being_baseline: float | None = None
...
class Phase20PilotActivation:
    ...
    def enroll_participant(self,
                          site_id: str,
                          demographic_group: str | None = None,
                          baseline_assessment: dict[str, Any] | None = None) -> Participant:
        """
    ...
    def configure_data_collection(self,
                                 ...
                                 data_streams: list[str] | None = None) -> DataCollectionConfig:
        """
    ...
    def enroll_batch_participants(self,
                                 site_id: str,
                                 count: int,
                                 demographic_distribution: dict[str, float] | None = None) -> list[Participant]:
        """
...
def main():
    ...
    print("  ✓ Contexts covered: 3 (Education, Healthcare, Workplace)")
