...
from gcs.empathy_engine import EmotionalState  # noqa: E402
from gcs.models.affective_model import build_affective_model, compile_affective_model  # noqa: E402

# Pydantic models for API
if FASTAPI_AVAILABLE:
    class AffectivePredictionRequest(BaseModel):
        eeg: list[list[float]] | None = None
        physio: list[float] | None = None
...
class AffectiveServer:
    ...
    def get_streaming_data(self) -> dict[str, np.ndarray] | None:
