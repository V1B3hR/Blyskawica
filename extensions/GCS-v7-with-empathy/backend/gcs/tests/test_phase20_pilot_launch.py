...
from societal_pilot_framework import PilotContext
...
class TestPhase20PilotLaunch(unittest.TestCase):
    ...
    def test_q1_2026_full_launch(self):
        ...
        # Verify contexts
        contexts = set(site.context for site in self.launcher.pilot_manager.sites.values())  # noqa: C401
    ...
    def test_irb_approvals_registered(self):
        ...
        summary = self.launcher.launch_q1_2026_pilot_sites(dry_run=False)  # noqa: F841
