...
class DNACompiler:
    ...
    def compile(self, dna_source: str, optimize: bool = True) -> bytes:
        ...
        try:
            ...
            raise RuntimeError(f"Compilation error: {e}")  # noqa: B904
                    ...
                    for j in range(operand_count):
                        if i + 4 + (j + 1) * 4 <= len(sequences):
                            ...
                            try:
                                ...
                                # Invalid operand
                                raise ValueError(f"Invalid operand sequence: {operand_seq}")  # noqa: B904
    ...
    def _combine_sequential_operations(self, instructions: List[Dict]) -> List[Dict]:
        ...
        while i < len(instructions):
            ...
            if i + 1 < len(instructions):
                next_instr = instructions[i + 1]  # noqa: F841
