...
def example_1_enhanced_redaction():
    ...
    pipeline = EnhancedRedactionPipeline(
        policy=RedactionPolicy.AGGRESSIVE,  # noqa: F821
        enable_audit=True,
...
def example_2_differential_privacy():
    ...
    # Privacy audit
    audit = PrivacyAudit(dp)  # noqa: F821
...
def example_4_data_minimization():
    ...
    record1 = dm.store_data(
        ...
        category=DataCategory.PERSONAL_IDENTIFIABLE,  # noqa: F821
        user_id=user_id,
    ...
    record2 = dm.store_data(
        ...
        category=DataCategory.OPERATIONAL,  # noqa: F821
        user_id=user_id
    )
