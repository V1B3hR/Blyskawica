...
def demo_validation_workflow(replayer: ActionReplayer):
    ...
    if change_rate < 5:
        print("    ✅ APPROVED: Low impact, safe to deploy")
    elif change_rate < 20:
        print("    ⚠️  CAUTION: Moderate impact, review changes carefully")
    else:
        print("    ❌ REJECTED: High impact, requires additional review")
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            # Setup demo data
            action_count = setup_demo_database(db_path)  # noqa: F841
