...
def demo_marketplace_client():
    ...
    try:
        ...
        financial_plugin = PluginInfo(  # noqa: F821
        ...
        healthcare_plugin = PluginInfo(  # noqa: F821
...
def demo_plugin_governance():
    ...
    try:
        governance = PluginGovernance(storage_dir=temp_dir)  # noqa: F821
...
def demo_community_manager():
    ...
    try:
        community = CommunityManager(storage_dir=temp_dir)  # noqa: F821
...
def demo_detector_packs():
    ...
    registry = DetectorPackRegistry()  # noqa: F821
    ...
    print("\n--- Industry Packs ---")
    industries = [Industry.FINANCIAL, Industry.HEALTHCARE, Industry.LEGAL]  # noqa: F821
    ...
    # By industry
    results = registry.search_packs(industry=Industry.FINANCIAL)  # noqa: F821
...
def demo_integration_directory():
    ...
    directory = IntegrationDirectory()  # noqa: F821
    ...
    data_sources = directory.list_integrations(
        integration_type=IntegrationType.DATA_SOURCE  # noqa: F821
    )
    ...
    temp_dir = tempfile.mkdtemp()
    try:
        exporter = ExportUtility()  # noqa: F821
        importer = ImportUtility()  # noqa: F821
...
def demo_integrated_governance():
    ...
    print("  Note: This integrates marketplace plugins with the governance system")
