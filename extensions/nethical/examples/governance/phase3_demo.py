...
from nethical.core import DetectorTier, Phase3IntegratedGovernance, SamplingStrategy
...
def demo_correlation_engine():
    ...
    for i in range(5):
        for j in range(i + 1):
            ...
            matches = engine.track_action(f"agent_{i}", action, f"payload_{j}")  # noqa: F841
...
def demo_fairness_sampling():
    ...
    print("   Assigned 30 agents to 3 cohorts")
...
def demo_performance_optimizer():
    ...
    from nethical.core import PerformanceOptimizer
    ...
    for risk in risk_scores:
        ...
        for name, tier in detectors:  # noqa: B007
