...
def demo_pinecone():
    ...
    try:
        from nethical.integrations.vector_stores import PineconeConnector  # noqa: F401
...
def demo_weaviate():
    ...
    try:
        from nethical.integrations.vector_stores import WeaviateConnector  # noqa: F401
