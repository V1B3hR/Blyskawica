...
class AppealRecord(BaseModel):
    ...
    resolution: str | None = Field(None, description="Resolution if decided")
    resolution_reason: str | None = Field(None, description="Reason for resolution")
    reviewer_id: str | None = Field(None, description="Reviewer ID if assigned")
...
async def list_appeals(
    ...
    appellant_id: str | None = Query(None, description="Filter by appellant"),
    decision_id: str | None = Query(None, description="Filter by decision"),
