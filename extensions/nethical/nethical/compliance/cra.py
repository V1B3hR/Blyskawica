...
class CyberResilienceActCompliance:
    ...
    def __init__(self, product_info: ProductInfo):
        ...
        self.risk_classification: CRAProductRiskResult | None = None
    ...
    def classify_product_risk(self) -> CRAProductRiskResult:
        ...
        if "ai" in self.product_info.product_name.lower() or \
           ...
           "safety" in self.product_info.product_name.lower():  # noqa: SIM102
        ...
        try:
            if requirements_path.exists():
                with open(requirements_path) as f:
                    for line in f:
                        line = line.strip()
                        if line and not line.startswith('#'):  # noqa: SIM102
