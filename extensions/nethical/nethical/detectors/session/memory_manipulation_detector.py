...
class MemoryManipulationDetector(BaseDetector):
    ...
    async def detect_violations(self, action: AgentAction) -> Sequence[SafetyViolation] | None:
        ...
        if mem_matches >= 2:
            confidence += 0.6
            evidence.append("Memory manipulation patterns detected")
        elif mem_matches >= 1:
            confidence += 0.4
            evidence.append("Potential memory manipulation detected")
        ...
        if source_matches >= 2:
            confidence += 0.4
            evidence.append("Source spoofing patterns detected")
        elif source_matches >= 1:
            confidence += 0.2
            evidence.append("Potential source spoofing detected")
        ...
        if confidence >= 0.3:
            ...
            violations.append(SafetyViolation(
                ...
                description="Memory manipulation attempt detected",
                evidence=evidence,
