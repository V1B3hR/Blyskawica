...
class MultiTurnDetector(BaseDetector):
    ...
    async def detect_violations(self, action: AgentAction) -> Sequence[SafetyViolation] | None:
        ...
        if assembly_score > 0:
            evidence.append("Delayed payload assembly detected")
        ...
        if confidence >= 0.3:
            ...
            violations.append(SafetyViolation(
                ...
                description="Multi-turn staging attack detected",
                evidence=evidence,
                timestamp=datetime.now(timezone.utc),
