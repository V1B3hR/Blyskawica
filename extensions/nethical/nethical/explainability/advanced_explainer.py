...
class AdvancedExplainer:
    ...
    def calculate_shap_values(
        ...
        base_risk = 0.3  # Neutral baseline  # noqa: F841
    ...
    def _generate_feature_explanation(
        ...
        if abs(total_positive) > abs(total_negative):
            parts.append("Overall: Features pushed towards blocking/restricting the action.")
        elif abs(total_negative) > abs(total_positive):
            parts.append("Overall: Features supported allowing the action.")
        else:
            parts.append("Overall: Features were balanced between allowing and blocking.")
