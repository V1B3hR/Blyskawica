...
class ChallengeResult:
    ...
    weakness_found: DetectorWeakness | None = None
...
class DetectorChallenger:
    ...
    def _generate_recommendations(
        ...
        for weakness in weaknesses:
            if weakness in weakness_recommendations:
                recommendations.append(weakness_recommendations[weakness])  # noqa: PERF401
    ...
    def get_detector_profile(self, detector_id: str) -> DetectorProfile | None:
