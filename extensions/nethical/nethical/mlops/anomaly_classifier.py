...
if _TORCH_AVAILABLE:
    ...
    def build_tokenizer(sequences):
        ...
        actions = set(a for seq in sequences for a in seq)  # noqa: C401
    ...
    def extract_features(sequence):
        ...
        unique_pairs = set(tuple(sequence[i:i+2]) for i in range(len(sequence)-1))  # noqa: C401
