...
class AdaptiveGuardian:
    ...
    def __init__(
        self,
        pulse_callback: Callable[[ThreatAnalysis], None] | None = None,
        alert_callback: Callable[[TripwireAlert], None] | None = None,
        watchdog_callback: Callable[[WatchdogAlert], None] | None = None,
    ):
...
_guardian_instance: AdaptiveGuardian | None = None
