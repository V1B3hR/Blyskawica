...
class PostgresBackend:
    ...
    def __init__(self, config: PostgresConfig | None = None, enabled: bool = True):
        """
    ...
    def get_model_version(self, model_name: str, version: str) -> dict[str, Any] | None:
    ...
    def revoke_api_key(self, key_hash: str, reason: str | None = None) -> bool:
        """Revoke an API key."""
        if not self.enabled:
            return False
