...
class TestDependencyChaos:
    ...
    def test_cache_failure_resilience(self, chaos_injector):
        ...
        if not cache_available and db_available:  # noqa: SIM108
...
class TestRecoveryBehavior:
    ...
    def test_recovery_after_database_failure(self, chaos_injector):
        ...
        # Inject failure
        experiment = chaos_injector.inject_database_failure(  # noqa: F841
            failure_type="connection_refused",
    ...
    def test_recovery_time_measurement(self, chaos_injector):
        ...
        # Inject chaos
        experiment = chaos_injector.inject_latency(  # noqa: F841
            target="api",
            latency_ms=50,
            duration_seconds=0.5
        )
...
class TestChaosFramework:
    ...
    def test_chaos_experiment_lifecycle(self):
        ...
        # Add chaos
        exp1 = injector.inject_latency("api", 100)  # noqa: F841
        exp2 = injector.inject_cpu_stress(50)  # noqa: F841
