...
from nethical.observability.alerts import AlertRule, AlertRuleManager, AlertSeverity
...
class TestTracing:
    ...
    def test_nested_spans(self):
        ...
        with tracer.start_span("parent") as parent_span, tracer.start_span("child") as child_span:
...
class TestAlertRules:
    ...
    def test_evaluate_rules(self):
        ...
        fired = manager.evaluate_rules(metrics)  # noqa: F841
