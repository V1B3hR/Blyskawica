...
class TestPhase4Integration:
    ...
    def test_secret_management_complete_flow(self):
        ...
        # Create secrets
        api_key = system.create_secret("api-key-1", SecretType.API_KEY, length=32)  # noqa: F841
        password = system.create_secret("password-1", SecretType.PASSWORD, length=24)  # noqa: F841
