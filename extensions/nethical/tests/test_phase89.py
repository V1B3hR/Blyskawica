...
class TestPhase8HumanFeedback:
    ...
    def test_sla_metrics(self, escalation_queue):
        ...
        case = escalation_queue.add_case(  # noqa: F841
            judgment_id="judg_1",
            action_id="act_1",
            agent_id="agent_1",
            decision="block",
...
class TestPhase9Optimization:
    ...
    def test_promotion_gate(self, optimizer):
        ...
        baseline_metrics = optimizer.record_metrics(  # noqa: F841
        ...
        candidate_metrics = optimizer.record_metrics(  # noqa: F841
...
class TestPhase89Integration:
    ...
    def test_continuous_improvement_cycle(self, governance):
        ...
        result = governance.process_with_escalation(  # noqa: F841
            judgment_id="judg_1",
            action_id="act_1",
            agent_id="agent_1",
            decision="block",
