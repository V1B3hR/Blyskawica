...
class TestAuthenticationRequest:
    ...
    def setup_method(self):
        ...
        set_auth_manager(self.auth)  # noqa: F821
    ...
    def test_authenticate_with_jwt(self):
        ...
        user_id = authenticate_request(authorization_header=auth_header)  # noqa: F821
    ...
    def test_authenticate_with_api_key(self):
        ...
        user_id = authenticate_request(api_key_header=key_string)  # noqa: F821
    ...
    def test_authenticate_no_credentials(self):
        ...
        with pytest.raises(AuthenticationError):  # noqa: F821
            authenticate_request()  # noqa: F821

    def test_authenticate_invalid_header_format(self):
        """Test authentication with invalid header format"""
        with pytest.raises(AuthenticationError):  # noqa: F821
            authenticate_request(authorization_header="InvalidFormat token")  # noqa: F821
    ...
    def test_authenticate_expired_token(self):
        ...
        set_auth_manager(auth)  # noqa: F821

        token, _ = auth.create_access_token("user123")
        auth_header = f"Bearer {token}"

        with pytest.raises(AuthenticationError):  # noqa: F821
            authenticate_request(authorization_header=auth_header)  # noqa: F821
