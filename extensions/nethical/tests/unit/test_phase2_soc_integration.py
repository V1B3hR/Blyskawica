...
class TestIncidentManager:
    ...
    async def test_list_incidents_filtered(self):
        ...
        inc1 = await manager.create_incident("Inc 1", "Desc 1", AlertSeverity.HIGH)  # noqa: F841
        inc2 = await manager.create_incident("Inc 2", "Desc 2", AlertSeverity.CRITICAL)  # noqa: F841
