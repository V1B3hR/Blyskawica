...
class LoadTester:
    ...
    def run_synchronous_load_test(self, num_requests: int = 100,
        ...
        for i in range(num_requests):
            ...
            try:
                result = self.governance.process_action(  # noqa: F841
...
def test_sustained_load_performance(load_tester):
    ...
    for batch in range(batches):
        ...
        all_latencies.extend([l * 1000 for l in [  # noqa: E741
    ...
    avg_p95 = mean([l for l in all_latencies if l < 1000])  # Filter outliers  # noqa: E741
