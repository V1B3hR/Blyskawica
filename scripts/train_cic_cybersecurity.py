...
from adaptiveneuralnetwork.immune_system.cognitive_capacitor import CognitiveCapacitor  # noqa: E402
...
def train_cic_ddos2019(capacitor: CognitiveCapacitor):
    ...
    print("-> Ingestia 50 sekwencji ruchu sieciowego CIC-DDoS2019...")
...
def train_cic_ids2017(wolf_teeth: WolfTeethDefenseEngine):
    ...
    print("-> Ładowanie wektorów ataku z CIC-IDS2017:")
...
def train_cic_malmem2022(identity_guard: IdentityGuard):
    ...
    print("-> Weryfikacja integralności tożsamości kognitywnej Błyskawicy...")
