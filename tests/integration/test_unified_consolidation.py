...
from adaptiveneuralnetwork.central_nervous_system.phases import PhaseScheduler, SubPhase
...
class TestPhaseBasedConsolidation:
    ...
    def test_phase_consolidation_logic(self):
        ...
        # Set some nodes to sleep phase (phase 1) and sub-phase DEEP (phase 3)
        phase_scheduler.node_phases[2:4] = 1  # Two nodes in sleep phase
        phase_scheduler.node_sub_phases[2:4] = SubPhase.DEEP.value  # Set to deep sleep sub-phase
...
class TestBackwardCompatibility:
    ...
    def test_plugin_system_compatibility(self):
        ...
        from adaptiveneuralnetwork.central_nervous_system.plugin_system import ConsolidationPhase
