...
class TestBackendFactory:
    ...
    @patch('adaptiveneuralnetwork.central_nervous_system.jax_backend.is_jax_available')
    ...
    @patch('adaptiveneuralnetwork.central_nervous_system.jax_backend.is_jax_available')
    @patch('adaptiveneuralnetwork.central_nervous_system.jax_backend.JAXAdaptiveModel')
    ...
    def test_neuromorphic_backend_creation(self):
        ...
        with patch('adaptiveneuralnetwork.central_nervous_system.neuromorphic.NeuromorphicAdaptiveModel') as mock_neuro_model:
            mock_instance = MagicMock()
