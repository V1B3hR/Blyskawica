...
class TestCIFAR10Corrupted:
    ...
    def test_corrupted_dataset_creation(self):
        ...
        with patch('torchvision.datasets.CIFAR10') as mock_cifar:
            ...
            mock_dataset.__len__ = lambda *args: len(mock_data)
            mock_dataset.__getitem__ = lambda *args: mock_data[args[0] if len(args) > 0 else args]
...
class TestCIFAR10Benchmark:
    ...
    def test_standard_benchmark_quick(self):
        ...
        with patch('adaptiveneuralnetwork.benchmarks.vision.cifar10.load_cifar10') as mock_load:
    ...
    def test_robustness_benchmark_structure(self):
        ...
        with patch('adaptiveneuralnetwork.benchmarks.vision.cifar10.load_cifar10') as mock_clean:
            with patch('adaptiveneuralnetwork.benchmarks.vision.cifar10.load_cifar10_corrupted') as mock_corrupt:
                # Mock clean data
