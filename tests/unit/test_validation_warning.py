...
def test_warning_message_format():
    ...
    assert expected_message in log_contents, "Warning message format is incorrect!"
...
def test_warning_format_matches_requirement():
    ...
    assert all_present, "Missing components in format"
...
if __name__ == "__main__":
    ...
    try:
        test_warning_format_matches_requirement()
        test2_passed = True
    except AssertionError:
        test2_passed = False
